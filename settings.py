...
# Platforms
PLATFORM_COLOR = ICE
PLATFORM_COLOR_LIGHT = LIGHT_ICE
PLATFORM_SIZE = (100,10)
PLATFORM_SPEED = 3
PLATFORM_DISTANCE_GAP = (70,110)
MAX_PLATFORM_NUMBER = 10
BONUS_SPAWN_CHANCE = 15
BREAKABLE_PLATFORM_CHANCE = 9
SLIDEABLE_PLATFORM_CHANCE = 15
